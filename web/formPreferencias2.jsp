<%-- TesteTags07.jsp --%>
<%-- Este arquivo só tem formatação de tags HTML --%>

<html>
<body> 

<h1>Página formPreferencias2.jsp</h1>
<h4>Está página abrirá a página processaPreferencias2.jsp.<br>
Visual separado do processamento: duas páginas diferentes.</h4>
